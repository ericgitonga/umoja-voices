...
export default function NewSongPage() {
  return (
    <div className="mx-auto max-w-lg px-4 py-10">
      <h1 className="mb-6 text-2xl font-semibold text-slate-900">New song</h1>
      <form action={createSong} className="flex flex-col gap-4">
        ...
        <label className="flex flex-col gap-1 text-sm">
          Section label
          <select name="sectionLabel" className="rounded border border-slate-300 px-3 py-2" defaultValue="SATB_COMPULSORY">
